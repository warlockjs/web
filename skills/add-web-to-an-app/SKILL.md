...
On the refusal path, free `/` yourself and create a page with either `export const config = { route: { path: "/", name: "index" } } satisfies PageConfig` or another literal `config.route`.
